...
export const metadata: Metadata = {
  title: "Model Registration By A7Entertainment & Parker Models — New Horizon",
  description:
    "Complete the form to submit your profile for the Orion Model Hunt audition.",
  alternates: { canonical: "https://www.a7entertainment.in/model-registration-NewHorizon" },
  robots: { index: false, follow: false },
  openGraph: {
    url: "https://www.a7entertainment.in/model-registration-NewHorizon",
    title: "Model Registration (New Horizon) | A7 Entertainment",
    description:
      "New Horizon students — Orion Model Hunt.",
  },
};

export default function ModelRegistrationNewHorizonPage() {
  return (
    <main className="bg-black">
      ...
      <ModelRegistrationForm
        mode="free"
        endpoint="/api/audition/submit-newhorizon"
        showRollNumber
        universityName="New Horizon"
      />
    </main>
  );
}
