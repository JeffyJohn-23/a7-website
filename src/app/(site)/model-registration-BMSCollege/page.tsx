...
export const metadata: Metadata = {
  title: "Model Registration By A7Entertainment & Parker Models — BMS College",
  description:
    "Complete the form to submit your profile for the Orion Model Hunt audition.",
  alternates: { canonical: "https://www.a7entertainment.in/model-registration-BMSCollege" },
  robots: { index: false, follow: false },
  openGraph: {
    url: "https://www.a7entertainment.in/model-registration-BMSCollege",
    title: "Model Registration (BMS College) | A7 Entertainment",
    description:
      "BMS College students — Orion Model Hunt.",
  },
};
  ...
  return (
    <main className="bg-black">
      ...
      <ModelRegistrationForm
        mode="free"
        endpoint="/api/audition/submit-bms"
        showRollNumber
        universityName="BMS College"
      />
    </main>
  );
}
