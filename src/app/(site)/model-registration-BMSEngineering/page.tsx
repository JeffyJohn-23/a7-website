...
export const metadata: Metadata = {
  title: "Model Registration By A7Entertainment & Parker Models — BMS Engineering",
  description:
    "Complete the form to submit your profile for the Orion Model Hunt audition.",
  alternates: { canonical: "https://www.a7entertainment.in/model-registration-BMSEngineering" },
  robots: { index: false, follow: false },
  openGraph: {
    url: "https://www.a7entertainment.in/model-registration-BMSEngineering",
    title: "Model Registration (BMS Engineering) | A7 Entertainment",
    description:
      "BMS Engineering students — Orion Model Hunt.",
  },
};

export default function ModelRegistrationBMSEngineeringPage() {
  return (
    <main className="bg-black">
      ...
      <ModelRegistrationForm
        mode="free"
        endpoint="/api/audition/submit-bmsengineering"
        showRollNumber
        universityName="BMS Engineering"
      />
    </main>
  );
}
