...
const services = [
  ...
  { number: "07", title: "Digital Marketing",     description: "Driving measurable growth through data-driven strategies. From performance marketing and social media to SEO and content campaigns, we build digital ecosystems that amplify your brand and deliver real results.",                                 tag: "Digital Acceleration",  color: "#171717" },
  ];
