...
export const metadata: Metadata = {
  title: "Model Registration By A7Entertainment & Parker Models — BGS",
  description:
    "Complete the form to submit your profile for the Orion Model Hunt audition.",
  alternates: { canonical: "https://www.a7entertainment.in/model-registration-BGS" },
  robots: { index: false, follow: false },
  openGraph: {
    url: "https://www.a7entertainment.in/model-registration-BGS",
    title: "Model Registration (BGS) | A7 Entertainment",
    description:
      "BGS students — Orion Model Hunt.",
  },
};

export default function ModelRegistrationBGSPage() {
  return (
    <main className="bg-black">
      ...
      <ModelRegistrationForm
        mode="free"
        endpoint="/api/audition/submit-bgs"
        showRollNumber
        universityName="BGS"
      />
    </main>
